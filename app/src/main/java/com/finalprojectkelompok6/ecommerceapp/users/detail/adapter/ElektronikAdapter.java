...
public class ElektronikAdapter extends RecyclerView.Adapter<ElektronikAdapter.HandphoneViewHolder> {
    private final Context context;
    private final List<Handphone> list;

    public ElektronikAdapter(Context context, List<Handphone> list) {
    ...
    public HandphoneViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_elektronik, parent, false);
